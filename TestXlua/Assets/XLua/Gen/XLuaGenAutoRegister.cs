...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(BaseClass), BaseClassWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(TestEnum), TestEnumWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DrivenClass), DrivenClassWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(ICalc), ICalcWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(DrivenClassExtensions), DrivenClassExtensionsWrap.__Register);
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(DrivenClass.TestEnumInner), DrivenClassTestEnumInnerWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(ItfD), ItfDBridge.__Create);
