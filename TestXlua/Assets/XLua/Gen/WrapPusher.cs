...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<TestEnum>(translator.PushTestEnum, translator.Get, translator.UpdateTestEnum);
				...
				translator.RegisterPushAndGetAndUpdate<DrivenClass.TestEnumInner>(translator.PushDrivenClassTestEnumInner, translator.Get, translator.UpdateDrivenClassTestEnumInner);
        ...
        int TestEnum_TypeID = -1;
		int TestEnum_EnumRef = -1;
        
        public void PushTestEnum(RealStatePtr L, TestEnum val)
        {
            if (TestEnum_TypeID == -1)
            {
			    bool is_first;
                TestEnum_TypeID = getTypeId(L, typeof(TestEnum), out is_first);
				
				if (TestEnum_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(TestEnum));
				    TestEnum_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, TestEnum_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, TestEnum_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for TestEnum ,value="+val);
            }
			
			LuaAPI.lua_getref(L, TestEnum_EnumRef);
        ...
        public void Get(RealStatePtr L, int index, out TestEnum val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != TestEnum_TypeID)
				{
				    throw new Exception("invalid userdata for TestEnum");
				}
                ...
                {
                    throw new Exception("unpack fail for TestEnum");
                }
				val = (TestEnum)e;
            ...
            {
                val = (TestEnum)objectCasters.GetCaster(typeof(TestEnum))(L, index, null);
            }
        }
		
        public void UpdateTestEnum(RealStatePtr L, int index, TestEnum val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for TestEnum ,value="+val);
                }
            }
        ...
        int DrivenClassTestEnumInner_TypeID = -1;
		int DrivenClassTestEnumInner_EnumRef = -1;
        
        public void PushDrivenClassTestEnumInner(RealStatePtr L, DrivenClass.TestEnumInner val)
        {
            if (DrivenClassTestEnumInner_TypeID == -1)
            {
			    bool is_first;
                DrivenClassTestEnumInner_TypeID = getTypeId(L, typeof(DrivenClass.TestEnumInner), out is_first);
				
				if (DrivenClassTestEnumInner_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(DrivenClass.TestEnumInner));
				    DrivenClassTestEnumInner_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, DrivenClassTestEnumInner_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, DrivenClassTestEnumInner_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for DrivenClass.TestEnumInner ,value="+val);
            }
			
			LuaAPI.lua_getref(L, DrivenClassTestEnumInner_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out DrivenClass.TestEnumInner val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != DrivenClassTestEnumInner_TypeID)
				{
				    throw new Exception("invalid userdata for DrivenClass.TestEnumInner");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for DrivenClass.TestEnumInner");
                }
				val = (DrivenClass.TestEnumInner)e;
                
            }
            else
            {
                val = (DrivenClass.TestEnumInner)objectCasters.GetCaster(typeof(DrivenClass.TestEnumInner))(L, index, null);
            }
        }
		
        public void UpdateDrivenClassTestEnumInner(RealStatePtr L, int index, DrivenClass.TestEnumInner val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for DrivenClass.TestEnumInner ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			{
			    TestEnum[] array = obj as TestEnum[];
				translator.PushTestEnum(L, array[index]);
				return true;
			}
			...
			else if (type == typeof(DrivenClass.TestEnumInner[]))
			{
			    DrivenClass.TestEnumInner[] array = obj as DrivenClass.TestEnumInner[];
				translator.PushDrivenClassTestEnumInner(L, array[index]);
				return true;
			}
