...
namespace XLua.CSObjectWrap
{
    ...
    public class TestEnumWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginObjectRegister(typeof(TestEnum), L, translator, 0, 0, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E1", TestEnum.E1);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E2", TestEnum.E2);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushTestEnum(L, (TestEnum)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushTestEnum(L, TestEnum.E1);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "E2"))
                {
                    translator.PushTestEnum(L, TestEnum.E2);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for TestEnum!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for TestEnum! Expect number or string, got + " + lua_type);
            }
    ...
    public class DrivenClassTestEnumInnerWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(DrivenClass.TestEnumInner), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(DrivenClass.TestEnumInner), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(DrivenClass.TestEnumInner), L, null, 3, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E3", DrivenClass.TestEnumInner.E3);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "E4", DrivenClass.TestEnumInner.E4);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(DrivenClass.TestEnumInner), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushDrivenClassTestEnumInner(L, (DrivenClass.TestEnumInner)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushDrivenClassTestEnumInner(L, DrivenClass.TestEnumInner.E3);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "E4"))
                {
                    translator.PushDrivenClassTestEnumInner(L, DrivenClass.TestEnumInner.E4);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for DrivenClass.TestEnumInner!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for DrivenClass.TestEnumInner! Expect number or string, got + " + lua_type);
            }
