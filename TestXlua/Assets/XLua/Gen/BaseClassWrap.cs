...
namespace XLua.CSObjectWrap
{
    ...
    public class BaseClassWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BaseClass);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BaseClass constructor!");
        ...
        static int _g_get_BSF(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.xlua_pushinteger(L, BaseClass.BSF);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_BSF(RealStatePtr L)
        {
		    try {
			    ...
			    BaseClass.BSF = LuaAPI.xlua_tointeger(L, 1);
