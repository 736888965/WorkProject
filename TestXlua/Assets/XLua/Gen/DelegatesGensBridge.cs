...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(int p0, string p1, out DClass p2)
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (DClass)translator.GetObject(L, errFunc + 2, typeof(DClass));
		...
		public XLua.LuaEnv __Gen_Delegate_Imp16()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp17(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(FDelegate))
			{
			    return new FDelegate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(GetE))
			{
			    return new GetE(__Gen_Delegate_Imp1);
			}
