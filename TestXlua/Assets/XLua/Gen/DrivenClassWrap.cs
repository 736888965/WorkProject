...
namespace XLua.CSObjectWrap
{
    ...
    public class DrivenClassWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DrivenClass);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DrivenClass gen_ret = new DrivenClass();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DrivenClass constructor!");
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<DrivenClass>(L, 1) && translator.Assignable<DrivenClass>(L, 2))
				{
					DrivenClass leftside = (DrivenClass)translator.GetObject(L, 1, typeof(DrivenClass));
					DrivenClass rightside = (DrivenClass)translator.GetObject(L, 2, typeof(DrivenClass));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of + operator, need DrivenClass!");
        ...
        static int _m_ComplexFunc(RealStatePtr L)
        {
		    try {
                ...
                {
                    Param1 _p1;translator.Get(L, 2, out _p1);
        ...
        static int _m_TestFunc(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DrivenClass.TestFunc!");
        ...
        static int _m_DefaultValueFunc(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DrivenClass.DefaultValueFunc!");
        ...
        static int _m_EnumTestFunc(RealStatePtr L)
        {
		    try {
                ...
                {
                    TestEnum _e;translator.Get(L, 2, out _e);
                    
                        TestEnum gen_ret = gen_to_be_invoked.EnumTestFunc( _e );
                        translator.PushTestEnum(L, gen_ret);
        ...
        static int _e_TestEvent(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to DrivenClass.TestEvent!");
            return 0;
        }
