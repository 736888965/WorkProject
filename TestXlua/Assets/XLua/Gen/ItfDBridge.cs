...
{
    public class ItfDBridge : LuaBase, ItfD
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new ItfDBridge(reference, luaenv);
		}
		
		public ItfDBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int ItfD.add(int a, int b)
		{
