...
{
    [Serializable]
    public class LFloat:IEquatable<LFloat>, IComparable<LFloat>
    {
        /// <summary>
        /// 精度
        /// </summary>
        ...
        /// -1
        /// </summary>
        public static readonly LFloat negOne = new LFloat(true, -Precision);
        ...
        {
            this._val = val * Precision;
        }

        public LFloat(long val)
        {
            this._val = (int)(val * Precision);
        }
#if UNITY_EDITOR
        ...
        public static LFloat operator *(int a, LFloat b)
        {
            return new LFloat(true, a  * b._val);
        }
        public static LFloat operator /(int a, LFloat b)
        {
        ...
        public static implicit operator short(LFloat value)
        {
        ...
        public static implicit operator LFloat(long value)
        {
            return new LFloat(true, value * Precision);
        }
        ...
        public static implicit operator LFloat(double value)
        {
            return new LFloat(true, (long)(value * Precision));
        }
        public static implicit operator double(LFloat value)
        {
            return (double)value._val * 0.001f;
        }
        #endregion
