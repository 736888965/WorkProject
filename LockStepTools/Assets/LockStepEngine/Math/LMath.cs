...
namespace LockStep.Math
{
    ...
    public static partial class LMath
    {
        ...
        {
            int num = (int)(val._val * (long)LUTAcos.HALF_COUNT / LFloat.Precision) + LUTAcos.HALF_COUNT;
        ...
        {
            int num = (int)(val._val * (long)LUTAsin.HALF_COUNT / LFloat.Precision) + LUTAsin.HALF_COUNT;
        ...
        public static void SinCos(out LFloat cos, out LFloat sin, LFloat radians)
        {
            int index = LUTSinCos.getIndex(radians);
        ...
        public static LFloat Round(LFloat val)
        {
            ...
            else
            {
                var remainder = (val._val) % LFloat.Precision;
                if (remainder > LFloat.HalfPrecision)
                    return new LFloat(true, val._val - remainder + LFloat.HalfPrecision);
                else
                    return new LFloat(true, val._val - remainder);
            }
        }
