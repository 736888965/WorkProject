...
namespace LockStep.Logging
{
    public static class Logger
    {
        ...
        public static event EventHandler<LogEventArgs> OnMessage = DefaultSeverLogHandler;

        public static Action<bool, string> OnAssert;

        public static void SetLogAllSeverities()
        {
            LogSeverityLevel = LogSeverity.Trace | LogSeverity.Info |
                LogSeverity.Warn | LogSeverity.Error | LogSeverity.Exception;
        }
        ...
        private static void DefaultSeverLogHandler(object sender, LogEventArgs logArgs)
        {
